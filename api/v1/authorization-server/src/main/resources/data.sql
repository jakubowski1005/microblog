...
INSERT INTO user_details (id, username,password, email, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked)
VALUES ('1', 'artur','{bcrypt}$2y$12$kXgf8LDBClbzghUCcijBZ.7JJcMqywNCf267uU8CJZ/YsXtXgdl4a', 'artur@gmail.com', '1', '1', '1', '1');

INSERT INTO  user_details (id, username,password, email, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked)
VALUES ('2', 'martyna', '{bcrypt}$2y$12$kXgf8LDBClbzghUCcijBZ.7JJcMqywNCf267uU8CJZ/YsXtXgdl4a','martynka@gmail.com', '1', '1', '1', '1');

INSERT INTO ROLE_USER (ROLE_ID, USER_ID)
    VALUES
    (1, 1) /* artur-admin */,
    (2, 2) /* martyna-operatorr */ ;