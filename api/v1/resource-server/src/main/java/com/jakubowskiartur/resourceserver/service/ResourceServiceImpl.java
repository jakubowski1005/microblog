...
public class ResourceServiceImpl implements ResourceService {
    ...
    static {
        resources = Arrays.asList(
                new Resource(1, "First resource", 13.45),
                new Resource(2, "Second resource", -89.43265),
                new Resource(3, "Third resource", 1.01),
                new Resource(4, "Fourth resource", 0.1),
                new Resource(5, "Fifth resource", 69.09));
    }
